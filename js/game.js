...
const CHARACTERS = [
  { id: "raven", label: "Raven", src: "assets/characters/raven.png", type: "character" },
  { id: "salem", label: "Salem", src: "assets/characters/salem.png", type: "character" },
  { id: "bo", label: "Bo", src: "assets/characters/bo.png", type: "character" },
  { id: "willow", label: "Willow", src: "assets/characters/willow.png", type: "character" },
];

const ITEMS = [
  { id: "cat-bed", label: "Cat bed", src: "assets/items/cat-bed.png", type: "item" },
  { id: "cookie", label: "Cookie", src: "assets/items/cookie.png", type: "item" },
  { id: "feather", label: "Feather", src: "assets/items/feather.png", type: "item" },
  { id: "leaf", label: "Leaf", src: "assets/items/leaf.png", type: "item" },
  { id: "mouse", label: "Mouse toy", src: "assets/items/mouse.png", type: "item" },
  { id: "rock", label: "Rock", src: "assets/items/rock.png", type: "item" },
  { id: "security-blanket", label: "Security blanket", src: "assets/items/security-blanket.png", type: "item" },
  { id: "sock", label: "Sock", src: "assets/items/sock.png", type: "item" },
];
...
const HINT_IDLE_MS = 10000; // 10 seconds of quiet time
const TARGET_COUNT = 5; // Raven + 4 others
...
function pickTargets() {
  ...
  const chosenOthers = shuffle(others).slice(0, TARGET_COUNT - 1);
  return shuffle([raven, ...chosenOthers]);
}
...
function objectSizePx(difficulty, sceneWidth) {
  ...
  if (difficulty === "easy") {
    return Math.max(70, base * 0.09);
  }
  return Math.max(52, base * 0.065);
}
...
function showHint() {
  ...
  setTimeout(() => img.classList.remove("hint"), 2500);
}
